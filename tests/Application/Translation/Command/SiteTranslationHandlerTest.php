 ...
 * @coversNothing
 */
class SiteTranslationHandlerTest extends HandlerTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->register(Command\SiteTranslationHandler::class, new Command\SiteTranslationHandler($repository));
    ...
    public function itSitesExistingTranslationTest(): void
    {
        ...
        foreach ($collection->getArrayCopy() as $eventStream) {
            ...
            $this->assertTrue($entity->getSites()->equals($event->translationSites()));
        }
