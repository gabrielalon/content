 ...
 * @coversNothing
 */
class TranslateNewsHandlerTest extends HandlerTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->register(Command\TranslateNewsHandler::class, new Command\TranslateNewsHandler($repository));
     ...
     * @throws \Exception
     */
    public function itCategorizesExistingNewsTest(): void
    {
        //given
        ...
        foreach ($collection->getArrayCopy() as $eventStream) {
            ...
            $this->assertTrue($entity->getNames()->equals($event->newsContent()->names()));
            $this->assertTrue($entity->getContents()->equals($event->newsContent()->texts()));
        }
